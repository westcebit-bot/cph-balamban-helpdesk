...
export const HeaderBrand: React.FC = () => {
  return (
    <div className="flex items-center space-x-3 bg-white px-4 py-2 border-b border-slate-200">
      <div className="w-10 h-10 rounded-full bg-sky-900 border-2 border-amber-400 flex items-center justify-center text-white shadow-xs shrink-0 font-extrabold text-sm">
        CPH
      </div>
      <div>
